...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0F0C29] text-white selection:bg-purple-500/30 font-sans">
      ...
      <nav className="fixed top-0 w-full z-50 bg-[#0F0C29]/80 backdrop-blur-md border-b border-purple-500/10 h-16 flex items-center justify-between px-6 md:px-12">
        ...
        <div className="flex items-center space-x-6">
          <button className="text-xs font-black uppercase tracking-widest text-slate-400 hover:text-white transition-colors">Sign In</button>
          <button
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden flex flex-col items-center text-center px-6">
        ...
        <div className="relative z-10 max-w-5xl space-y-10">
          <div className="inline-flex items-center space-x-2 px-4 py-1.5 bg-purple-500/10 border border-purple-500/20 rounded-full mb-4">
            <span className="text-[10px] font-black text-purple-400 uppercase tracking-widest italic">🚀 136 Tools • 8 Phases • Free to Start</span>
          </div>

          <h1 className="text-6xl md:text-8xl font-black tracking-tighter leading-tight text-white flex flex-col items-center uppercase italic">
            <span>Dominate Your</span>
            <span className="bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent mt-2">Local SEO Journey</span>
            <span className="mt-2">At Scale</span>
          </h1>
      ...
      <section id="features" className="py-24 px-6 max-w-7xl mx-auto scroll-mt-20">
        <h2 className="text-3xl md:text-5xl font-black text-center text-white italic mb-16 tracking-tight uppercase">Built for every type of<br /><span className="text-purple-400">Local SEO professional</span></h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-stretch">
          {[
            ...
            <div key={card.id} className="bg-[#1A1740] border border-white/5 p-8 rounded-3xl hover:border-purple-500/50 transition-all duration-300 group flex flex-col min-h-[200px]">
      ...
      <section id="phases" className="py-24 bg-black/20 scroll-mt-20">
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-[#1A1740] border border-white/5 rounded-3xl p-10 space-y-6">
            ...
            <h3 className="text-xl font-black text-white italic uppercase tracking-tighter">Rank & Rent Automation</h3>
          ...
          <div className="bg-[#1A1740] border border-purple-500/30 rounded-3xl p-10 space-y-6 shadow-2xl shadow-purple-900/10 transform md:-translate-y-4">
            ...
            <h3 className="text-xl font-black text-white italic uppercase tracking-tighter">AI Niche Finder</h3>
          ...
          <div className="bg-[#1A1740] border border-white/5 rounded-3xl p-10 space-y-6">
            ...
            <h3 className="text-xl font-black text-white italic uppercase tracking-tighter">Bring Your Own API Key</h3>
      ...
      <section className="py-32 px-6">
        <div className="max-w-4xl mx-auto rounded-[3rem] bg-gradient-to-br from-purple-600/20 to-indigo-600/20 border border-purple-500/20 p-12 md:p-20 text-center space-y-8 relative overflow-hidden backdrop-blur-3xl">
          ...
          <h2 className="text-4xl md:text-6xl font-black text-white italic tracking-tight uppercase">Ready to dominate<br />local search?</h2>
          <button
            onClick={handleGetStarted}
      ...
      {/* SECTION 9: FOOTER */}
      <footer id="contact" className="bg-[#0A0818] border-t border-[#2D2B55] py-12 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-500 text-sm leading-relaxed">
              The complete Local SEO toolkit for professionals. Build, rank and rent like a pro.
            </p>
            <div className="flex items-center space-x-6">
          ...
          {/* Column 2 */}
          <div className="space-y-6">
            <h4 className="text-white font-bold uppercase tracking-tighter text-sm">Platform</h4>
            <div className="flex flex-col space-y-3">
              {['Dashboard', 'Research Phase', 'Build Phase', 'Pricing', 'Blog (coming soon)'].map(item => (
                <button key={item} className="text-left text-gray-400 hover:text-white transition-colors text-xs font-bold uppercase tracking-widest">
                  {item}
                </button>
              ))}
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col space-y-3">
              {['Documentation', 'API Keys Setup', 'DataForSEO Guide', 'Support'].map(item => (
                <button key={item} className="text-left text-gray-400 hover:text-white transition-colors text-xs font-bold uppercase tracking-widest">
                  {item}
                </button>
              ))}
        ...
        {/* Bottom Bar */}
        <div className="max-w-7xl mx-auto border-t border-[#1A1740] pt-6 mt-12 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-gray-600 text-[10px] font-bold uppercase tracking-widest italic">
            © 2025 SEO AI Platform. All rights reserved.
          </p>
          <div className="flex items-center space-x-6 text-gray-600 text-[10px] font-bold uppercase tracking-widest italic">
