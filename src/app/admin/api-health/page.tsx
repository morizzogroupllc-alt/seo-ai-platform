...
export default function ApiHealthPage() {
    ...
    const UsageBar = ({ icon, name, calls, limit }: any) => {
        ...
        return (
            <div className="admin-card bg-[#1A1740] border border-[#2D2B55] p-5 rounded-2xl hover:border-purple-500/50 transition-all">
                ...
                <div className="bg-[#2D2B55] rounded-full h-2 overflow-hidden">
        ...
        <div className="space-y-10 animate-fadeIn pb-10">
            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    {/* Service 1: Supabase */}
                    <div className="bg-[#1A1740] border border-[#2D2B55] rounded-3xl p-8 admin-card relative overflow-hidden group hover:border-green-500/30 transition-all">
                    ...
                    <div className="bg-[#1A1740] border border-[#2D2B55] rounded-3xl p-8 admin-card relative overflow-hidden group hover:border-blue-500/30 transition-all">
                        <div className="flex items-center justify-between mb-8 relative z-10">
                            <div className="flex items-center gap-4">
                    ...
                    {/* Service 3: Gemini AI */}
                    <div className="bg-[#1A1740] border border-[#2D2B55] rounded-3xl p-8 admin-card relative overflow-hidden group hover:border-purple-500/30 transition-all">
                        <div className="flex items-center justify-between mb-8 relative z-10">
                            <div className="flex items-center gap-4">
                    ...
                    {/* Service 4: Stripe */}
                    <div className="bg-[#1A1740] border border-[#2D2B55] rounded-3xl p-8 admin-card relative overflow-hidden group hover:border-yellow-500/30 transition-all">
                        <div className="flex items-center justify-between mb-8 relative z-10">
                            <div className="flex items-center gap-4">
                    ...
                    <div className="bg-[#1A1740] border border-[#2D2B55] border-dashed rounded-3xl p-8 admin-card relative overflow-hidden group opacity-60">
                        <div className="flex items-center justify-between mb-8 relative z-10">
                            <div className="flex items-center gap-4">
                ...
                {toasts.map(toast => (
                    <div
                        ...
                        className={cn(
                            ...
                            toast.type === 'success'
                                ? "bg-[#1A1740]/90 backdrop-blur-xl border-green-500/30 text-green-400"
                                : "bg-[#1A1740]/90 backdrop-blur-xl border-red-500/30 text-red-400"
                        )}
                    >
                        <div className={cn(
