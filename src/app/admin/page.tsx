                    ...
                    <div className="grid grid-cols-2 gap-4">
                        {[
                            ...
                            <button key={i} onClick={() => router.push(action.path)}
                                className="bg-[#1E1E1E] border border-[#333333] rounded-xl p-6 flex flex-col items-center justify-center gap-3 group hover:border-purple-500 transition-all duration-300 hover:bg-purple-500/5">
                                    ...
                                    <div className="flex items-center gap-1.5">
                                        ...
                                        {item.status === 'not_configured' && (
                                            <button
                                                ...
                                                className="text-[9px] px-1.5 py-0.5 bg-[#1E1E1E] border border-[#333333] hover:border-purple-500 text-gray-400 hover:text-white rounded transition-all">
                                                Configure →
                                            </button>
                                        )}
                                    </div>
